...
show_all_project_button.addEventListener("click", ()=> {
    ...
    if (tag.style.display === "none") {
        tag.style.display = "flex"; // showing tag
...
function show_hide_tag(tag, btn) {
    if (tag.style.display === "none") {
        ...
        btn.textContent = "Hide Description "; // when tagcription is showen ask for hide
    } else {
        tag.style.display = "none"; // hidding tag
        btn.textContent = "Show Description"; // when tagcription is hidden ask for show
    }
}   
